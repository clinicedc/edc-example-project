...
from .lab_profiles import cd4_panel, viral_load_panel, fbc_panel, chemistry_panel

app_label = "example_main"
...
requisitions = FormsCollection(
    ...
    Requisition(show_order=20, panel=viral_load_panel, required=True, additional=False),
)

requisitions3 = FormsCollection(
    Requisition(show_order=10, panel=viral_load_panel, required=True, additional=False)
)
